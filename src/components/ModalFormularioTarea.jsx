...
const ModalFormularioTarea = () => {
    const { modalFormularioTarea, handleModalTarea, mostrarAlerta, alerta, submitTarea, handleModalEditarTarea, tarea } = useProyectos();
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form className='my-10' onSubmit={handleSubtit}>
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase font-bold text-sm' htmlFor='nombre'>Nombre</label>
                                            <input id='nombre' type="text" placeholder='Nombre' className='border-2 w-full p-2 mt-2 placeholder-gray400 rounded-md'
                                                value={nombre} onChange={e => setNombre(e.target.value)} />
                                        </div>
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase font-bold text-sm' htmlFor='descrip'>Descripcion</label>
                                            <textarea id='descrip' type="text" placeholder='Descripcion' className='border-2 w-full p-2 mt-2 placeholder-gray400 rounded-md'
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            <input id='fecha' type="date" placeholder='' className='border-2 w-full p-2 mt-2 placeholder-gray400 rounded-md'
                                                value={fechaEntrega} onChange={e => setFechaEntrega(e.target.value)} />
                                        </div>
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase font-bold text-sm' htmlFor='prio'>Prioridad</label>
                                            <select id='prio' type="text" className='border-2 w-full p-2 mt-2 placeholder-gray400 rounded-md'
