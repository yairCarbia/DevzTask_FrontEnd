...
const EditarProyecto = () => {
    ...
    const { obtenerProyecto, cargando, setCargando, proyecto, eliminarProyecto } = useProyectos();
    useEffect(() => {
        ...
        cargando ? (
            ...
            <>
                ...
                <div className='flex justify-between items-center gap-2 m-2'>
                    ...
                    <div className=' flex items-center gap-2 text-gray-400 hover:text-black hover:font-bold uppercase'>
                        ...
                        <button
                            className='uppercase font-bold ' onClick={handleClick}>Eliminar</button>
